/**----------------------------------------------------------------------------
 * Brukernavn: syhd
 * Oblig4 - INF2440(UiO Spring 2016)

 * Konvekse Innhyllinga - Et rekursivt geometrisk problem
 * Note that a new method merge() has been added to the InnList class to make
...
class Oblig4 {
	...
	public void runTests(int ntests) {
		...
		for(n = 100000000; n >= 10; n /= 10) test(ntests);
	}
